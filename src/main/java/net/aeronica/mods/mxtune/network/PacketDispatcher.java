...
public class PacketDispatcher
{
    ...
    private static final <T extends AbstractMessage<T> & IMessageHandler<T, PacketBuffer>> void registerMessage(Class<T> clazz)
    {
        ...
        {
            PacketDispatcher.channel.registerMessage(clazz, clazz, packetId++, LogicalSide.CLIENT);
...
//            return this.indexedCodec.addCodecIndex(index, messageType, encoder, decoder, messageConsumer);
            PacketDispatcher.channel.registerMessage(clazz, clazz, packetId++, LogicalSide.SERVER);
            PacketDispatcher.channel.registerMessage(packetId++, clazz);
