...
public class MusicTextMessageOld extends AbstractServerMessage<MusicTextMessageOld>
{
    String musicTitle;
    String musicText;
    ...
    public MusicTextMessageOld(String musicTitle, String musicText)
    {
    ...
    public void process(EntityPlayer player, Side side)
    {
        ...
        {
            ItemStack musicbook = player.getHeldItemMainhand();
            if (!musicbook.hasDisplayName())
            {
                System.out.println("+++ Write Music book NBT +++");
                musicbook.setStackDisplayName("-" + musicTitle + "-");
