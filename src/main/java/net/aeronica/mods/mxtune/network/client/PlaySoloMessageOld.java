...
public class PlaySoloMessageOld extends AbstractClientMessage<PlaySoloMessageOld>
{
    ...
    public PlaySoloMessageOld() {}

    public PlaySoloMessageOld(Integer playerID)
    {
    ...
    public PlaySoloMessageOld(Integer playerID, String musicTitle, String musicText, boolean isPlaced)
    {
        this.playerID = playerID;
    ...
    public PlaySoloMessageOld(Integer playerID, BlockPos pos, boolean isPlaced)
    {
        this.playerID = playerID;
        this.musicTitle = "";
        this.musicText = "";
