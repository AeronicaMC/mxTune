...
public class EntityTimpaniSave extends EntitySlime
{
    
    public EntityTimpaniSave(World worldIn)
    {
        super(worldIn);
...
//    }
    ...
    @Override
    protected EntityTimpaniSave createInstance()
    {
        return new EntityTimpaniSave(this.world);
    }
