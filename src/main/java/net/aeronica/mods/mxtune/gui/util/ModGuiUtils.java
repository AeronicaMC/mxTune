...
public class ModGuiUtils
{
    ...
    public <T extends Screen, S extends Object>  void drawHooveringHelp(T guiScreen, List<S> hooverTexts, int guiLeft, int guiTop, int mouseX, int mouseY)
    {
    ...
    public static <T extends TextFieldWidget> void clearOnMouseLeftClicked(T guiTextField, int mouseX, int mouseY, int mouseButton)
    {
