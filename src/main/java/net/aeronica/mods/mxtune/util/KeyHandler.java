...
import net.aeronica.mods.mxtune.network.SendKeyMessage;
...
public class KeyHandler
{
    ...
    public static net.aeronica.mods.mxtune.util.KeyHandler getInstance() {return KeyHandlerHolder.INSTANCE;}
