...
public class ModelGoldenSkeleton extends ModelBiped
{

    public ModelGoldenSkeleton()
    {
        this(0.0F, false);
    }

    public ModelGoldenSkeleton(float modelSize, boolean p_i46303_2_)
    {
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime)
    {
        ...
        if (itemstack.getItem() == Items.BOW && ((EntityGoldenSkeleton)entitylivingbaseIn).isSwingingArms())
        {
